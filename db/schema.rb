...
ActiveRecord::Schema.define(:version => 20111211183116) do
  ...
  create_table "profiles", :force => true do |t|
    t.integer  "user_id"
    t.string   "oauth_token",  :limit => 500, :null => false
    t.string   "name"
    t.string   "first_name"
    t.string   "last_name"
    t.string   "location"
  ...
  create_table "settings", :force => true do |t|
    t.integer  "social_app_id",            :null => false
    t.string   "canvas_url"
  ...
  create_table "social_posts", :force => true do |t|
    t.string   "post_type",              :limit => 50, :null => false
    t.string   "name"
    t.string   "link"
    t.string   "picture"
    t.string   "caption"
